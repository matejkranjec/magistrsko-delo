...
trainer = Trainer(model=model, args=args, tokenizer=tokenizer, train_dataset=tokenized_train, eval_dataset=tokenized_val, compute_metrics=ca, preprocess_logits_for_metrics=preprocess_logits_for_metrics)

...
trainer.save_model(os.path.join(FINAL_MODELS_DIR, f"{MODEL_NAME}-c"))

merged_model = model.merge_and_unload()
merged_model.save_pretrained(os.path.join(FINAL_MODELS_DIR, f"{MODEL_NAME}-combined"))
